...
class CustomQuickTimeRenderHook(HookBaseClass):
    """
    CustomQuickTimeRenderHook hook implementation for the tk-nuke engine.
    """

    def __init__(self, *args, **kwargs):
        super(CustomQuickTimeRenderHook, self).__init__(*args, **kwargs)
